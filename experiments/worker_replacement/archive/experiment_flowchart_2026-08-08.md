...
> **SUPERSEDED as of 2026-08-06** — this diagram (and `rendered_flowchart.png`) depicts the
> pre-revamp silent-change experiment, abandoned 2026-08-04. Do not paste into slides or cite
> for current design; the authoritative brief is
> `manager_agent_gym/experiments/ds_reroute/STUDY1_FOUNDATION.md`. Frozen copy:
> `manager_agent_gym/experiments/ds_reroute/archive/experiment_flowchart_2026-07-18.md`.
